    ...
    <main className="hero-shell">
      <div className="hero-card">
        <header className="site-header">
          ...
          <nav className="desktop-nav" aria-label="Main navigation"><a className="active" href="#top">Home</a><a href="#how-it-works">How it works</a><a href="#who-its-for">Who it&apos;s for</a><a href="#compare">Compare</a><a href="#testimonials">Testimonials</a><a href="#night-desk">Night Desk</a></nav>
          <a className="header-cta" href="#how-it-works">Get Started</a>
        </header>
        <section className="hero-content" id="top">
          <div className="copy-column"><p className="eyebrow"><span className="eyebrow-dot" /> Private settlement</p><h1>Invoices that<br />stay <em>private</em></h1><p className="intro">Create, share, and settle invoices with private amounts and verifiable proof when your team needs it.</p><div className="hero-actions"><a className="primary-button" href="#how-it-works">Get Started <span aria-hidden="true">→</span></a><a className="text-button" href="#how-it-works">See how it works</a></div></div>
